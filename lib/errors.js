...
// The source file is protected/encrypted (e.g. password protected)
class SourceProtectedError extends ClientError {
    constructor(message) {
        super(message, "SourceProtectedError", Reason.SourceProtected);

        Error.captureStackTrace(this, SourceProtectedError);
    }
}
