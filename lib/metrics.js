 ...
 */
 ...
 const { NewRelic } = require('../../node-openwhisk-newrelic/index');
 ...
 class AssetComputeMetrics {
    ...
    constructor(params) {
        ...
        if (!this.params.newRelicEventsURL || !this.params.newRelicApiKey) {
            ...
            // initialize Apache OpenWhisk New Relic Agent
    ...
    */
    ...
    /**
     * End Apache OpenWhisk New Relic Agent after sending all events
     */
    close() {
        if (!this.defaultMetrics) {
            return;
