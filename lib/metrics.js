    ...
    */
    async handleError(error, options) {
        ...
        if (error instanceof ClientError) {
            ...
            this.sendErrorMetrics(error.location || options.location || actionName(), message, options.metrics);
            ...
            this.sendErrorMetrics(options.location || actionName(), message, metrics);
        }
    }
}
