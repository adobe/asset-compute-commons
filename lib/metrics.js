...
class AssetComputeMetrics {
    ...
    */
    ...
    /**
     * Immediately sends `activation_start` metrics. This method should never throw an exception.
     *
     * Call this when your openwhisk action has started. Does nothing on multiple calls
     *
     * @param {Object} metrics all custom metrics to be included in the New Relic event
    ...
    async activationStarted(metrics={}, sendActivationStartMetrics=true) {
        ...
        if (sendActivationStartMetrics === true) {
    ...
    async activationFinished(metrics={}, sendActivationMetrics=true) {
        console.log('##################');
        console.log('Finishing activation metrics (from metrics)');
        console.log('##################');
