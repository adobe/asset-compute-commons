 ...
 class AssetComputeMetrics {
    ...
    constructor(params) {
        ...
        if (!this.params.newRelicEventsURL || !this.params.newRelicApiKey) {
            ...
            if(this.params.source) {
                this.defaultMetrics.sourceName = this.params.source.name || undefined;
                this.defaultMetrics.sourceMimetype = this.params.source.mimetype || undefined
                this.defaultMetrics.sourceSize = this.params.source.size || undefined;
            }
    ...
    async sendMetrics(eventType, metrics) {
        ...
        try {
            ...
            if (response.ok) {
                console.log(`NewRelic event sent: ${await JSON.stringify(response.json())}`);
            } else {
