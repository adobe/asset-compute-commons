 ...
 */
 ...
 class AssetComputeMetrics {
    ...
    constructor(params, options) {
        ...
        if (!this.params.newRelicEventsURL || !this.params.newRelicApiKey) {
            ...
            if (this.params.internal) {
                this.defaultMetrics.requestId = this.params.internal.requestId;
                this.defaultMetrics.clientName = this.params.internal.clientName;
            }
    ...
    async sendMetrics(eventType, metrics) {
        if (this.NewRelic) {
            metrics = Object.assign(metrics || {}, this.defaultMetrics);
