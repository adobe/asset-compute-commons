...
class AssetComputeWebhookEvents {
    ...
    constructor(options) {
        ...
        this.hmacPrivateKey = options.hmacPrivateKey || process.env.HMAC_PRIVATE_KEY;
    }
    ...
    async sendEvent(event, retryOptions) {        
        ...
        const signature = this.hmacPrivateKey ? generateHMACSignature(eventBody, this.hmacPrivateKey) : undefined;
